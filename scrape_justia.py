...
class AdvancedScraper:
    ...
    async def scrape_case_links(self, page, base_url):
        ...
        while True:
            case_links = await page.query_selector_all('strong > a[href^="/cases/federal/us/"]')
            ...
            for idx, case_link in enumerate(case_links):
                try:
                    ...
                    case_url = f"https://supreme.justia.com{case_url}"
...
async def main():
    ...
    base_url = "https://supreme.justia.com/cases-by-topic/labor-employment/"
